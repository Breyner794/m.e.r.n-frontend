...
const Users = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(`https://m-e-r-n-backend.onrender.com/api/auth/user`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://m-e-r-n-backend.onrender.com/api/auth/register`, {
        method: 'POST',
        headers: {
